export const SITE_NAME = "バーチャル花火大会";
export const SITE_DESCRIPTION =
  "メタバース空間で花火大会を開催。中止となった花火大会の代替案として、低コストで地域イベントを継続できます。全13回・延べ4,075名の開催実績。";
export const CONTACT_EMAIL = "takemura@takemura-techlab.com";
export const ORGANIZER_NAME = "武村達也";
export const ORGANIZER_BRAND = "タケムラテックラボ";
export const ORGANIZER_WEBSITE = "https://www.takemura-techlab.com/";
