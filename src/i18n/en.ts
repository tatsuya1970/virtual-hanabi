...
const eventsEn: HanabiEvent[] = [
  {
    ...
    editions: [
      ...
      { edition: 5, date: "Jul 18, 2026", participants: 130, eventUrl: "https://cluster.mu/e/2e625054-4fcc-4064-8a3c-b9250aee9e84", xSummaryUrl: "https://posfie.com/@tatsuya1970/p/9ceKJAW" },
    ],
  },
  {
    id: "tomo",
