...
export const ja: Dictionary = {
  ...
  meta: {
    ...
    description:
      "メタバース空間で花火大会を開催。中止となった花火大会の代替案として、低コストで地域イベントを継続できます。全14回・延べ4,205名の開催実績。",
    ogLocale: "ja_JP",
    keywords: [
      "バーチャル花火大会",
      "メタバース 花火大会",
  ...
  trackRecord: {
    title: "開催実績",
    subtitle: "2021年から5つの花火大会を開催。延べ4,205名が参加しました。",
    datasetDescription:
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "2021年から広島県内で5つの大会（呉・鞆の浦・広島・福山・宮島）を開催し、全14回・延べ4,205名が参加しました。",
      },
      {
        question: "運営者は誰ですか？",
        answer:
